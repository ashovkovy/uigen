              ...
              <div className="h-full flex flex-col bg-white">
                ...
                <div className="h-14 border-b border-neutral-200/60 px-6 flex items-center justify-between bg-neutral-50/50">
                  <div className="bg-white/60 border border-neutral-200/60 p-0.5 h-9 shadow-sm rounded-md flex items-center">
                    <button
                      onMouseDown={(e) => { e.preventDefault(); setActiveView("preview"); }}
                      className={`px-4 py-1.5 text-sm font-medium rounded-sm transition-all ${activeView === "preview" ? "bg-white text-neutral-900 shadow-sm" : "text-neutral-600"}`}
                    >
                      Preview
                    </button>
                    <button
                      onMouseDown={(e) => { e.preventDefault(); setActiveView("code"); }}
                      className={`px-4 py-1.5 text-sm font-medium rounded-sm transition-all ${activeView === "code" ? "bg-white text-neutral-900 shadow-sm" : "text-neutral-600"}`}
                    >
                      Code
                    </button>
                  </div>
